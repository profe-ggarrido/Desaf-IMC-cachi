...
mi_jugada = input('Elige "piedra", "papel" o "tijera": ')
...
#-----------------------------------------------------------------------------
    ...
    if mi_jugada == jugada_maquina:
        ...
        print(f'Plop ... Empatamos. Ambos tenemos {mi_jugada}.')
        game_over()
        ...
        print(f'¡Ganééééééééé Yo con {mi_jugada} y tu tienes {jugada_maquina}.')
    ...
    # --------------------------------    
        ...
        print(f'Guaaaaa... Perdíííííí, tengo {mi_jugada} y tu elegiste {jugada_maquina}.')
